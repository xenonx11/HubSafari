    ...
    <footer className="bg-secondary">
      <div className="container mx-auto px-4 py-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div>
            <h4 className="font-headline text-base font-semibold mb-3">Quick Links</h4>
          ...
          <div>
            <h4 className="font-headline text-base font-semibold mb-3">Contact Us</h4>
            <ul className="space-y-1.5 text-sm text-muted-foreground">
              <li className="flex items-start gap-2"><MapPin className="h-4 w-4 text-primary mt-0.5 shrink-0" /> <span>123 Flavor St, Foodie Town</span></li>
          ...
          <div>
            <h4 className="font-headline text-base font-semibold mb-3">Hours</h4>
            <ul className="space-y-1.5 text-sm text-muted-foreground">
        ...
        <div className="mt-6 pt-6 border-t border-border/50 text-center text-muted-foreground text-xs">

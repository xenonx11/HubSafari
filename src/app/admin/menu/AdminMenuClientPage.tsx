...
interface AdminMenuClientPageProps {
  initialMenuItems: MenuItem[];
}

export default function AdminMenuClientPage({ initialMenuItems }: AdminMenuClientPageProps) {
    ...
    useEffect(() => {
        ...
        if (session !== 'true') {
            ...
            setIsLoading(false); // Data is already loaded via props
        }
    }, [router]);

    // This function can be used to manually refresh data after an action
    const refreshPage = () => {
        router.refresh();
    };
    ...
    const handleDelete = async (itemId: string) => {
        startTransition(async () => {
            ...
            if (result.success) {
                ...
                // Instead of fetching, we just refresh the page to get new server-side props
                refreshPage();
            } else {
    ...
    // Replace the old useEffect data fetch with this to handle prop updates
    useEffect(() => {
